...
def add_treasure():
    ...
    try:
        # Ensure 'treasures' is your correct table name
        # Ensure 'lat', 'lng', and 'riddle' are your exact column names
        ...
        # This will return the exact error from Supabase to your browser console
        return jsonify({"error": str(e)}), 500
